...
if ($no_faktur == '') {
    // Ambil semua transaksi berdasarkan bengkel
    $q = mysqli_query($conn, "SELECT * FROM transaksi WHERE id_bengkel = '$id_bengkel' ORDER BY tanggal DESC");
    $list_transaksi = [];
...
// ===== Jika no_faktur tersedia =====

// Ambil transaksi header
$sql_transaksi = mysqli_query($conn, "SELECT * FROM transaksi WHERE no_faktur='$no_faktur' AND id_bengkel = '$id_bengkel' LIMIT 1");
