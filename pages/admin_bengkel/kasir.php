        ...
        $.ajax({
            ...
            success: function(res){
                if(res.status_code == 200){
                    ...
                    let uang_bayar = res.data.transaksi.uang_bayar;
                    let kembalian = res.data.transaksi.kembalian;
                    ...
                    $("#textKendaraan").val(res.data.transaksi.kendaraan);
                    $("#textNoPolisi").val(res.data.transaksi.no_polisi);
                    $("#statusTransaksi").val(res.data.transaksi.status);
                    $("#pelanggan").val(res.data.transaksi.id_pelanggan).trigger("change");
                    $("#teknisi").val(res.data.transaksi.id_teknisi).trigger("change");
                } else {
                    $("#totalBayar").val("0");
                }
            }
